    ...
    <main className="text-white lg:pl-[280px] p-8 pt-36">
      <div className="grid grid-cols-1 md:grid-cols-6 gap-2">
        <div className="md:col-span-5 relative">
          <img
            src="https://i.blogs.es/ea4ddf/dduhp_zv4aaxedj/1366_2000.jpg"
            alt=""
          ...
          <div className="absolute left-0 bottom-0 p-8 max-w-xl">
            ...
            <h2 className="text-4xl font-bold mb-4">
              The hunt is on in Fornite Charapter 2 - Season 5: Zero point
            </h2>
            <button className="text-lg flex items-center gap-2 py-4 px-6 bg-blue-600 hover:bg-blue-700 rounded-xl group transition-all">
              Play for free{" "}
            ...
            <li className="">
              <a className="flex items-center gap-2 text-lg lg:text-sm hover:bg-[#141414] transition-all">
                <img
                  ...
                  className="w-[80px] h-[80px] object-cover"
                />
                <span className="md:hidden lg:block">Cyberpunk 2077</span>
              </a>
            </li>
          </ul>
        </div>
